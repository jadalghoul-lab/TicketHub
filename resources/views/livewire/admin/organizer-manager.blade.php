<div class="max-w-screen-2xl mx-auto w-full space-y-8">
    ...
    <div class="flex flex-col md:flex-row gap-4 items-center justify-between bg-white dark:bg-slate-900 p-4 rounded-[2rem] border border-slate-50 dark:border-slate-800 shadow-sm">
        <div class="relative w-full md:w-96">
            ...
            <input type="text" wire:model.live="search" placeholder="Search by name, email or company..." class="w-full border-none rounded-xl py-3 pl-12 pr-4 text-sm focus:ring-2 focus:ring-indigo-500 transition-colors duration-150 dark:text-white" style="background-color: var(--input-bg) !important;">
        </div>
