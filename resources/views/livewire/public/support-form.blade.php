<div class="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-sm border border-slate-100 dark:border-slate-800 relative overflow-hidden transition-all duration-300">
    <h2 class="text-2xl font-bold text-slate-900 dark:text-white mb-8">Send a Message</h2>
    ...
    <form wire:submit.prevent="submit" class="space-y-6 relative z-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="group">
                <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 transition-colors group-focus-within:text-indigo-600 dark:group-focus-within:text-indigo-400">Your Name</label>
                <div class="relative">
                    ...
                    <input type="text" wire:model.blur="name" required class="w-full bg-slate-50 dark:bg-slate-800 border border-transparent rounded-xl pl-12 pr-4 py-3 text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900 focus:border-indigo-600 dark:focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/20 transition-all outline-none @error('name') !border-red-500 !focus:ring-red-100 @enderror">
                </div>
                @error('name') <span class="text-red-500 text-sm mt-2 block animate-pulse">{{ $message }}</span> @enderror
            </div>
            <div class="group">
                <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 transition-colors group-focus-within:text-indigo-600 dark:group-focus-within:text-indigo-400">Email Address</label>
                <div class="relative">
        ...
        <div class="group">
            <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 transition-colors group-focus-within:text-indigo-600 dark:group-focus-within:text-indigo-400">Subject</label>
            <div class="relative">
                ...
                <select wire:model.blur="subject" required class="w-full bg-slate-50 dark:bg-slate-800 border border-transparent rounded-xl pl-12 pr-4 py-3 text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900 focus:border-indigo-600 dark:focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/20 transition-all outline-none appearance-none @error('subject') !border-red-500 !focus:ring-red-100 @enderror">
        ...
        <div class="group">
            <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 transition-colors group-focus-within:text-indigo-600 dark:group-focus-within:text-indigo-400">Message</label>
            <div class="relative">
                ...
                <textarea wire:model.blur="message" rows="5" required class="w-full bg-slate-50 dark:bg-slate-800 border border-transparent rounded-xl pl-12 pr-4 py-3 text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900 focus:border-indigo-600 dark:focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/20 transition-all outline-none resize-none @error('message') !border-red-500 !focus:ring-red-100 @enderror"></textarea>
            </div>
            @error('message') <span class="text-red-500 text-sm mt-2 block animate-pulse">{{ $message }}</span> @enderror
        </div>

        <button type="submit" wire:loading.attr="disabled" class="w-full bg-indigo-600 dark:bg-indigo-500 text-white font-bold py-4 rounded-xl shadow-lg shadow-indigo-200 dark:shadow-none hover:bg-indigo-700 dark:hover:bg-indigo-600 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed">
